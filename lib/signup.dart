        ...
        if (_formkey.currentState.validate()) {
          ...
          if (_password == _confirmPassword)
            ...
            await _showMyDialog(
                ...
                "Please make sure, you confirm password field and password value matches.",
                "Ok", () {
                                ...
                                Center(
                                  child: InkWell(
                                    ...
                                    child: MaterialButton(
                                      onPressed: () async {
                                        try {
                                          if (await formSubmission()) {
                                            var signUp = await _auth
                                            ...
                                            if (signUp != null) {
                                              await _showMyDialog(
                                                  "Success!",
                                                  "You have been successfully signed up. Head on to our login page to sign in",
                                                  "Ok", () {
                                          ...
                                          await _showMyDialog(
                                              "Error",
                                              "Some error occurred while signing up.",
                                              "Ok", () {
                                            Navigator.of(context,
                                                    rootNavigator: true)
                                                .pop();
